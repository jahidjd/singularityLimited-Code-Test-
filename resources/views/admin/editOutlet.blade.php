                        ...
                        <form action="{{route('updateOutlet',$outlet->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <th>Name</th>
                                    <th>
                                        <input type="text" name="name" class="form-control" placeholder="Enter Outlet Name" value="{{$outlet->name}}">
                                       
                                    </th>
                                    <th>Address</th>
                                    <th>
                                        <input type="text" name="address" class="form-control" placeholder="Enter Outlet address" value="{{$outlet->address}}">
                                ...
                                <tr>
                                    <th>Open Time</th>
                                    <th>
                                        <input type="time" class="form-control" name="open_time" value="{{$outlet->open_time}}">
                                        
                                    </th>
                                    <th>Close Time</th>
                                    <th>
                                        <input type="time" class="form-control" name="close_time" value="{{$outlet->close_time}}">
                                       
                                    </th>
                                    <th>Visit Date</th>
                                    <th>
                                        <input type="date" name="visit_date" class="form-control" value="{{$outlet->visit_date}}">
                                ...
                                <tr>
                                    ...
                                    <th colspan="3">
                                        ...
                                        @php
                                           $files = json_decode($outlet->photo)
                                        @endphp
                                        @forelse ($files as $item)
                                            <img src="{{url('photo/outletPhoto/'.$item)}}" alt="" width="150px">
                                        @empty
